...
A CNN-based image classification model developed for identifying 20

wood species from wood micrograph images.
...
The model consists of a customized classification head followed by

fine-tuning of the later VGG16 convolutional layers.
...
The dataset consists of 6,312 curated wood micrograph images covering

20 wood species.



The images were provided for the undergraduate research project and
